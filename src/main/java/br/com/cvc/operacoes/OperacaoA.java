...
public class OperacaoA implements Operacao{
	...
	private final String MESSAGE_EXCEPTION = "O valor de sua transacao foi identificada como operacao do tipo A mas para a operacao ser concluida a transferencia tem que ser no mermo dia da solicitacao.";
	...
	public void calcularTaxa() throws ExceptionRegraDeNegocio {
		System.out.println(agendamentoValidao());
